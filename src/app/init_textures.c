...
static void	load_textures(t_tsr *tsr)
{
	...
	while (i < TILE_COUNT)
	{
		...
		while (j < 6)
		{
			tsr->world.tiles[i].region[j] = atlas_get(
				&tsr->atlas, tsr->world.tiles[i].keys[j]);
...
void	init_textures(t_tsr *tsr)
{
	static const char	*path[] = {"assets/tiles/stone.png",
		...
		"assets/skybox2_top.png", "assets/skybox2_down.png",
		"assets/skybox2_est.png", "assets/skybox2_west.png",
		"assets/skybox2_north.png", "assets/skybox2_south.png", 0};
	static const char	*key[] = {"stone", "dirt", "oak_planks", "iron_block",
		...
		"oak_log_top", "skybox_top", "skybox_down", "skybox_est", "skybox_west",
